  ...
  return (
    <Layout>
        ...
        <div className="w-full bg-gray-50 border border-gray-200 rounded shadow-lg p-6 lg:p-12">
          ...
          <form action="https://formspree.io/f/xbjejeby" method="POST">
            <div className="flex flex-col lg:flex-row justify-between gap-4 lg:gap-12 w-full">
              <div className="w-full mb-12">
                ...
                <input
                  ...
                  required
                  className="p-3 border border-gray-200 rounded shadow-lg w-full"
                />
              </div>
              <div className="w-full mb-12">
            ...
            <div className="flex w-full">
              <button
                type="submit"
                className="w-full rounded shadow text-center bg-primary px-1 py-3 text-white"
              >
                Submit
              </button>
            </div>
      ...
      <div className="">
        <iframe
          title="Trinity Map"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2859.3815367108705!2d-93.57619778461381!3d44.219802679105904!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x87f68f8f70a98d7b%3A0x83825fb46d532837!2sTrinity%20Lutheran%20Church!5e0!3m2!1sen!2sus!4v1618195755454!5m2!1sen!2sus"
          width="100%"
          height="450"
          style={{ border: "0" }}
          allowFullScreen
