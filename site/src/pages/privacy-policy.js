    ...
    <Layout>
      <div className="max-w-screen-xl mx-auto my-24">
        ...
        <div>
          ...
          <p className="mb-2">Last updated: January 13, 2023</p>
          <p className="mb-2">
          ...
          <h1 className="mb-4">Interpretation and Definitions</h1>
          <h2 className="mb-4">Interpretation</h2>
          <p className="mb-2">
          ...
          <ul className="mb-2 list-disc">
            ...
            <li className="ml-12">
              <p className="mb-2">
                ...
                in this Agreement) refers to Trinity Evangelical Lutheran
                Church, 415 Lake Street West Waterville, MN, 56096.
              </p>
            </li>
            <li className="ml-12">
              <p className="mb-2">
            ...
            <li className="ml-12">
              <p className="mb-2">
                <strong>Website</strong> refers to Trinity Evangelical Lutheran
          ...
          <h1 className="mb-4">Collecting and Using Your Personal Data</h1>
          <h2 className="mb-4">Types of Data Collected</h2>
          <h3 className="mb-2">Personal Data</h3>
          <p className="mb-2">
          ...
          <h2 className="mb-4">Use of Your Personal Data</h2>
          ...
          <h2 className="mb-4">Retention of Your Personal Data</h2>
          <p className="mb-2">
          ...
          <h2 className="mb-4">Transfer of Your Personal Data</h2>
          <p className="mb-2">
          ...
          <h2 className="mb-4">Delete Your Personal Data</h2>
          <p className="mb-2">
          ...
          <h2 className="mb-4">Disclosure of Your Personal Data</h2>
          ...
          <ul className="mb-2 list-disc">
            <li className="ml-12">Comply with a legal obligation</li>
            <li className="ml-12">Protect and defend the rights or property of the Company</li>
            <li className="ml-12">
            ...
            <li className="ml-12">Protect against legal liability</li>
          </ul>
          <h2 className="mb-4">Security of Your Personal Data</h2>
          <p className="mb-2">
          ...
          <h1 className="mb-4">Children's Privacy</h1>
          <p className="mb-2">
          ...
          <h1 className="mb-4">Links to Other Websites</h1>
          <p className="mb-2">
          ...
          <h1 className="mb-4">Changes to this Privacy Policy</h1>
          <p className="mb-2">
          ...
          <ul className="mb-2 list-disc">
            <li className="ml-12">
              <p className="mb-2">By email: tlchurch@frontiernet.net</p>
            </li>
            <li className="ml-12">
              <p className="mb-2">By phone number: 507.362.4454</p>
            </li>
          </ul>
        </div>
      </div>
